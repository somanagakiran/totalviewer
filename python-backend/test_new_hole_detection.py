"""
Test the new simplified hole detection
"""
...
from engine.hole_detector_v2 import HoleDetector, detect_holes_from_entities, count_holes_by_type

def simple_test():
    """Simple test with just a rectangle and a circle"""
    
    print("=== Testing New Simplified Hole Detection ===")
