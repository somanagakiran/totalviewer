"""
Test the optimized hole detection
"""
...
def simple_test():
    ...
    print("=== Testing Optimized Hole Detection ===")
...
def complex_test():
    """Test with complex geometry including arcs and mixed entities"""
    
    print("\n=== Complex Test with Arcs ===")
    ...
    entities = [
        ...
        # Arc hole
        {"type": "ARC", "center": [15, 15], "radius": 3, "start_angle": 0, "end_angle": 360},
        
        # Circle hole
        {"type": "CIRCLE", "center": [35, 15], "radius": 2.5},
        
        # Mixed hole (lines forming a pentagon)
        {"type": "LINE", "x1": 10, "y1": 20, "x2": 15, "y2": 25},
        {"type": "LINE", "x1": 15, "y1": 25, "x2": 20, "y2": 22},
        {"type": "LINE", "x1": 20, "y1": 22, "x2": 18, "y2": 17},
        {"type": "LINE", "x1": 18, "y1": 17, "x2": 12, "y2": 18},
        {"type": "LINE", "x1": 12, "y1": 18, "x2": 10, "y2": 20},
    ]
